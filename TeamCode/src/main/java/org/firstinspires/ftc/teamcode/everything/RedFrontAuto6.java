...
public class RedFrontAuto6 extends Methods {
    ...
    Pose intake1 = new Pose(118, 87, Math.toRadians(180));
    Pose prep2 = new Pose(97, 60, Math.toRadians(180));
    Pose intake2 = new Pose(127, 60, Math.toRadians(180));
    Pose park = new Pose(124, 100, Math.toRadians(0));
    Follower follower;
